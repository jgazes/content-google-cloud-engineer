...
PUBLIC_ASSETS="jrgla-public-bucket"

# This is the Storage bucket used for private assets. 
# The entire bucket is private by default
PRIVATE_ASSETS="jrgla-private-bucket"

# The name of the Pubsub topic to create / use
PUB_SUB_TOPIC="jrgla-items"

# The name of the custom network for the product and ads services
SERVICES_NETWORK="jrgla-app-network"

# The name of the product service subnet
PRODUCT_SUBNET="jrgla-prod-app-network-subnet"

# The name of the product service subnet
ADS_SUBNET="jrgla-ad-app-network-subnet"

# The name of the Kubernetes cluster used for the products service
PRODUCT_CLUSTER_NAME="jrgla-app-clusters"

# The name of the spanner instance
PRODUCT_DB_INSTANCE_NAME="jrgla-app-spanner-instance"

# The name of the spanner db
PRODUCT_DB_NAME="jrgla-app-spanner-db"
